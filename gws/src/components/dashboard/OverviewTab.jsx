...
import { TimeScaleToggle, computeScaleDivisions } from "./GanttTimeline";
import MobileProjectTimeline from "./MobileProjectTimeline";

export default function OverviewTab({ twp, allS, filtered, pcMap, projIcons, isMobile, timeDim, setTimeDim, ganttWidths }) {
